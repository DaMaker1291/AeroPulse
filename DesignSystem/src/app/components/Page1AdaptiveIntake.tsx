...
export function Page1AdaptiveIntake({ onUnlockNavigation, targetStatus: propTargetStatus, streamUrl, cameraStream, faceMesh, onPatientInfo, patientInfo }: Page1Props) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 flex-1 min-h-0">
      ...
      <div className="bg-[#16161A] rounded-2xl border border-[#1E1E22] flex flex-col w-full flex-1 lg:flex-[2] min-w-0 min-h-0">

        {/* Card header */}
        <div className="px-4 sm:px-6 pt-4 sm:pt-5 pb-3 sm:pb-4 border-b border-[#1E1E22] flex items-center justify-between flex-shrink-0">
        ...
        {/* Patient info form */}
        {showPatientForm && (
          <div className="px-4 sm:px-6 pt-3 sm:pt-4 pb-2 sm:pb-3 border-b border-[#1E1E22] flex-shrink-0">
        ...
        <div className="flex-1 overflow-y-auto min-h-0 flex flex-col">
          {/* Progress bar */}
          <div className="h-0.5 bg-[#1E1E22] flex-shrink-0">
            <motion.div
          ...
          {/* Question counter */}
          <div className="px-4 sm:px-6 pt-3 sm:pt-4 flex items-center justify-between flex-shrink-0">
          ...
          {/* Answer buttons — always visible at bottom */}
          <div className={`space-y-3 sm:space-y-4 flex-shrink-0 ${isMobile ? 'px-3 pb-3' : 'px-6 pb-6'}`}>
      ...
      <div className="bg-[#16161A] rounded-2xl border border-[#1E1E22] flex flex-col overflow-hidden w-full lg:flex-[1] min-w-0 min-h-[120px] lg:min-h-0">
